...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _particles_ParticleSystem_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./particles/ParticleSystem.js */ \"./src/js/particles/ParticleSystem.js\");\n/* harmony import */ var _particles_Particle_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./particles/Particle.js */ \"./src/js/particles/Particle.js\");\n\n\nvar particleCanvas = document.querySelector('#particle-canvas');\n\nif (particleCanvas) {\n  var PARTICLE_SYSTEM_WIDTH = window.innerWidth;\n  var PARTICLE_SYSTEM_HEIGHT = window.innerHeight;\n  var particles = [];\n\n  var createParticles = function createParticles(array) {\n    var NUMBER_OF_PARTICLES = 40;\n\n    for (var i = 0; i < NUMBER_OF_PARTICLES; i++) {\n      var PARTICLE_RADIUS = 4;\n      var PARTICLE_COLOR = '#BFB9FA';\n      var x = Math.round(Math.random() * PARTICLE_SYSTEM_WIDTH);\n      var y = Math.round(Math.random() * PARTICLE_SYSTEM_HEIGHT);\n      var particle = new _particles_Particle_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](x, y, PARTICLE_RADIUS, PARTICLE_COLOR);\n      array.push(particle);\n    }\n  };\n\n  createParticles(particles);\n  var particleSystem = new _particles_ParticleSystem_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](PARTICLE_SYSTEM_WIDTH, PARTICLE_SYSTEM_HEIGHT, particles, particleCanvas);\n  particleSystem.run();\n}\n\n//# sourceURL=webpack://orsoppgave/./src/js/particleEffect.js?");

/***/ }),

/***/ "./src/js/particles/Particle.js":
/*!**************************************!*\
  !*** ./src/js/particles/Particle.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
